...
export declare type AddSheetCallback = ({ key, sheet }: {
    key: string;
...
export declare type ExtendedCSSStyleSheet = CSSStyleSheet & {
    bucketName: string;
 ...
 */
export declare type IConcatenatedStyleSet<TStyleSet extends IStyleSetBase> = {
...
declare type InsertRuleArgs = {
    key?: string;
    sheet?: ExtendedCSSStyleSheet | null;
    rule?: string;
};

export declare type InsertRuleCallback = ({ key, sheet, rule }: InsertRuleArgs) => void;
 ...
 */
export declare type IProcessedStyleSet<TStyleSet extends IStyleSetBase> = {
 ...
 */
export declare interface ISerializedStylesheet {
 ...
 */
export declare type IStyleFunction<TStylesProps, TStyleSet extends IStyleSetBase> = (props: TStylesProps) => DeepPartial<TStyleSet>;
 ...
 */
export declare type IStyleFunctionOrObject<TStylesProps, TStyleSet extends IStyleSetBase> = IStyleFunction<TStylesProps, TStyleSet> | DeepPartial<TStyleSet>;
 ...
 * property.
 */
export declare type IStyleSet<TStyleSet extends IStyleSetBase = {
    [key: string]: any;
}> = {
    [P in keyof Omit_2<TStyleSet, 'subComponentStyles'>]: IStyle;
} & {
 ...
 */
export declare interface IStyleSetBase {
    [key: string]: any;
 ...
 */
declare type Omit_2<U, K extends keyof U> = Pick<U, Diff<keyof U, K>>;
